...
function setup() {
    ...
    for (let i = 0; i < numLarge; i++) {
        ...
        units.push(new Unit(
            ...
            largeRadius, 'blue', 800, 100, 30, 10, 15 // Quadrupled HP
        ));
    }
    ...
    for (let i = 0; i < numSmall; i++) {
        ...
        units.push(new Unit(
            ...
            smallRadius, 'blue', 320, 70, 50, 20, 5 // Quadrupled HP
        ));
    }
    ...
    // --- Enemy Units (Red) ---
     ...
     for (let i = 0; i < numLarge; i++) {
        ...
        units.push(new Unit(
            ...
            largeRadius, 'red', 800, 100, 30, 10, 15 // Quadrupled HP
        ));
    }
    // Place Small Units
    const enemySmallStartY = enemyStartY + 2 * spacing * 1.5;
     for (let i = 0; i < numSmall; i++) {
        ...
        units.push(new Unit(
            ...
            smallRadius, 'red', 320, 70, 50, 20, 5 // Quadrupled HP
        ));
    }
